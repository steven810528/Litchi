...
public class MyBrowseActivity extends ListActivity {
	...
	private void setViedoPlay_only(final FsInfo fi) {
		//
		Intent intent = new Intent();

		String url = "https://" + apiCfg.webRelay + "/webrelay/directdownload/"
				+ apiCfg.token + "/?dis=" + ApiCookies.sid + "&fi="
				+ fi.entryId;

		intent.setClass(actBrow, VideoPlayerActivity.class);
